    ...
    <div className="container-page section-padding">
      <div className="container-prose">
        ...
        <div className="mt-8 space-y-8 text-ink-body dark:text-ink-inverse-body">
          <section>
            <h2 className="font-serif text-display-3 font-bold text-ink dark:text-ink-inverse">1. Introduction</h2>
            <p className="mt-3 leading-relaxed">
              {siteConfig.name} (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) operates the website{' '}
              <a href={siteConfig.url} className="link-accent">
                {siteConfig.url}
              </a>
          ...
          <section>
            <h2 className="font-serif text-display-3 font-bold text-ink dark:text-ink-inverse">2. Information We Collect</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section>
            <h2 className="font-serif text-display-3 font-bold text-ink dark:text-ink-inverse">3. How We Use Your Information</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section>
            <h2 className="font-serif text-display-3 font-bold text-ink dark:text-ink-inverse">4. Third-Party Services</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section>
            <h2 className="font-serif text-display-3 font-bold text-ink dark:text-ink-inverse">5. Advertising</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section>
            <h2 className="font-serif text-display-3 font-bold text-ink dark:text-ink-inverse">6. Data Security</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section>
            <h2 className="font-serif text-display-3 font-bold text-ink dark:text-ink-inverse">7. Children&apos;s Privacy</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section>
            <h2 className="font-serif text-display-3 font-bold text-ink dark:text-ink-inverse">8. Changes to This Policy</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section>
            <h2 className="font-serif text-display-3 font-bold text-ink dark:text-ink-inverse">9. Contact Us</h2>
            <p className="mt-3 leading-relaxed">
