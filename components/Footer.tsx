      ...
      <div className="container-page section-padding">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            {/* Social links. Only confirmed profiles are advertised — see the
                `social` block in config/site.ts to flip a handle to confirmed
                once the real account exists. */}
            <div className="mt-4 flex space-x-4">
              {siteConfig.social.twitter.confirmed && (
                <a
              ...
              {siteConfig.social.facebook.confirmed && (
                <a
              ...
              {siteConfig.social.linkedin.confirmed && (
                <a
