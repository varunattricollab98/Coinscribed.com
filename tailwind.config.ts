  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        // Medium pace for the US market ticker (8 short cards) — readable but
        // not sluggish.
        'marquee-medium': 'marquee 55s linear infinite',
        // Slowest, calmest marquee for the news-headline strip so long
        // headlines are easy to read as they glide by.
